...
export function HandshakeIcon({ size = 24, color = "currentColor", style }: IconProps) {
  return (
...
export function MoneyIcon({ size = 24, color = "currentColor", style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
export function MegaphoneIcon({ size = 24, color = "currentColor", style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={style}>
...
export function BowlIcon({ size = 24, color = "currentColor", style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={style}>
      <path d="M12 21a9 9 0 0 0 9-9H3a9 9 0 0 0 9 9Z" />
      <path d="M7 21h10" />
      <path d="M19.5 12c.93-2.36 1.5-5 1.5-6a2 2 0 0 0-4 0c0 1 .57 3.64 1.5 6" />
      <path d="M9.5 12c.93-2.36 1.5-5 1.5-6a2 2 0 0 0-4 0c0 1 .57 3.64 1.5 6" />
    </svg>
  );
}

export function MedicalIcon({ size = 24, color = "currentColor", style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={style}>
      <path d="M8 2v4" />
      <path d="M16 2v4" />
...
export function CrossIcon({ size = 24, color = "currentColor", style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style}>
      <path d="M18 6 6 18" />
      <path d="m6 6 12 12" />
...
export function HourglassIcon({ size = 24, color = "currentColor", style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={style}>
      <path d="M5 22h14" />
      <path d="M5 2h14" />
