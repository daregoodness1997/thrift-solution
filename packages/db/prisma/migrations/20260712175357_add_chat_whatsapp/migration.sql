...
-- CreateIndex
CREATE UNIQUE INDEX "whatsapp_group_members_group_id_user_id_key" ON "whatsapp_group_members"("group_id", "user_id");
...
-- AddForeignKey
ALTER TABLE "whatsapp_group_members" ADD CONSTRAINT "whatsapp_group_members_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
