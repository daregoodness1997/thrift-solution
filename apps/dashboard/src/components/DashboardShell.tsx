...
const FALLBACK_NAV: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: "Wallet", href: "/wallet", icon: "M3 10h18M3 14h18M5 10v10a1 1 0 001 1h12a1 1 0 001-1V10M7 10V7a5 5 0 0110 0v3" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "My Defaults", href: "/my-defaults", icon: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" },
  ...
  },
  {
    title: "Management",
    items: [
      { label: "Circle Management", href: "/circle-management", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" },
