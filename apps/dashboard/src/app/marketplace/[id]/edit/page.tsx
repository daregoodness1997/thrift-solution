          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="mb-1.5 block text-xs font-semibold text-brand-dark">Status *</label>
              ...
              <div>
                ...
                {imageFile ? (
                  ...
                  <div className="flex items-center gap-3 rounded-xl border border-gray-200 bg-gray-50 p-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <span className="block text-xs font-medium text-brand-dark">Current image</span>
                      <span className="text-[10px] text-gray-500">Upload a new image to replace</span>
                    </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-2">
                <a href={`/marketplace/${id}`} className="rounded-full border border-gray-200 px-5 py-2.5 text-[13px] font-semibold text-gray-500 no-underline transition-all">
                  Cancel
                </a>
