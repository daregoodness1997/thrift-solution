          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                ...
                <div>
                  <label style={{ display: "block", fontSize: "12px", fontWeight: 600, color: "#2D2D2D", marginBottom: "0.375rem" }}>Status *</label>
              ...
              <div>
                ...
                {imageFile ? (
                  ...
                  <div style={{ padding: "0.75rem", borderRadius: "0.75rem", border: "1px solid #EAEAEA", backgroundColor: "#FAFAFA", display: "flex", alignItems: "center", gap: "0.75rem" }}>
                    <img src={existingImage} alt="Current" style={{ width: "64px", height: "64px", borderRadius: "0.5rem", objectFit: "cover" }} />
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <span style={{ fontSize: "12px", fontWeight: 500, color: "#2D2D2D", display: "block" }}>Current image</span>
                      <span style={{ fontSize: "10px", color: "#717171" }}>Upload a new image to replace</span>
                    </div>
                    <button type="button" onClick={handleRemoveExistingImage} style={{ background: "none", border: "none", cursor: "pointer", padding: "0.25rem", color: "#DC2626" }}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M18 6L6 18M6 6l12 12" /></svg>
                    </button>
                  </div>
                ) : (
              ...
              <div style={{ display: "flex", gap: "0.75rem", justifyContent: "flex-end", paddingTop: "0.5rem" }}>
                <a href={`/marketplace/${id}`} style={{ padding: "0.625rem 1.25rem", borderRadius: "9999px", fontSize: "13px", fontWeight: 600, color: "#717171", border: "1px solid #EAEAEA", textDecoration: "none", transition: "all 0.2s ease" }}>
                  Cancel
                </a>
