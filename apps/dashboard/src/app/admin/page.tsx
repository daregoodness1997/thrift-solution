...
interface AdminStats {
  ...
  pending: { kyc: number; loans: number; walletPayoutRequests: number; payoutAccounts: number };
...
export default function AdminDashboardPage() {
  ...
  const totalPending = stats ? stats.pending.kyc + stats.pending.loans + stats.pending.walletPayoutRequests + stats.pending.payoutAccounts : 0;
            ...
            <Card padding="1.5rem" className="mb-6 rounded-3xl">
              ...
              <div className="grid grid-cols-[repeat(auto-fit,minmax(160px,1fr))] gap-4">
                ...
                <PendingItem label="Loan Requests" count={stats.pending.loans} href="/admin/loans" />
                 <PendingItem label="Payout Requests" count={stats.pending.walletPayoutRequests} href="/admin/payout-requests" />
