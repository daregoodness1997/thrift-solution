    ...
    options: [
      {
        ...
        desc: "Web dev, data, AI, design",
        emoji: "💻",
      },
      {
        id: "business",
        label: "Business & Entrepreneurship",
        desc: "Startups, marketing, finance",
        emoji: "📈",
      },
      {
        id: "creative",
        label: "Creative & Media",
        desc: "Content, video, writing",
        emoji: "🎨",
      },
      {
        id: "trades",
        label: "Skilled Trades",
        desc: "Solar, construction, farming",
        emoji: "🔧",
      },
    ],
  },
    ...
    options: [
      {
        id: "beginner",
        label: "Beginner",
        desc: "Just starting out, eager to learn",
        emoji: "🌱",
      },
      {
        id: "intermediate",
        label: "Intermediate",
        desc: "Some experience, ready to level up",
        emoji: "🚀",
      },
      {
        id: "advanced",
        label: "Advanced",
        desc: "Experienced, looking for mentorship or grants",
        emoji: "⭐",
      },
    ],
  },
    ...
    options: [
      {
        ...
        desc: "Learn anytime, anywhere on your schedule",
        emoji: "📱",
      },
      {
        id: "cohort",
        label: "Live Cohort Program",
        desc: "Structured classes with peers and mentors",
        emoji: "👥",
      },
      {
        id: "hybrid",
        label: "Hybrid (Online + In-Person)",
        desc: "Best of both worlds with hands-on labs",
        emoji: "🏫",
      },
    ],
  },
