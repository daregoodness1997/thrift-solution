    ...
    <section className="relative overflow-hidden pb-24 pt-32 md:pb-32 md:pt-40">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 lg:grid-cols-12">
        <div className="flex flex-col gap-6 text-left lg:col-span-7">
          <div className="animate-fade-up inline-flex w-fit items-center gap-2 rounded-full border border-brand-primary/15 bg-gradient-to-r from-brand-primary/10 to-brand-accent/10 px-4 py-1.5" style={{ animationDelay: "0ms" }}>
          ...
          <h1 className="animate-fade-up font-display text-4xl font-extrabold leading-tight tracking-tight text-brand-dark sm:text-5xl md:text-6xl" style={{ animationDelay: "80ms" }}>
            The modern way to{" "}
          ...
          <p className="animate-fade-up max-w-xl text-base leading-relaxed text-brand-muted sm:text-lg" style={{ animationDelay: "160ms" }}>
            Arosco brings the centuries-old trust of Ajo into the digital age.
            Track contributions transparently, protect funds in secure escrow,
            and automate payouts for your community.
          </p>

          <div className="animate-fade-up my-2 grid max-w-lg grid-cols-3 gap-4 border-y border-brand-primary/10 py-4" style={{ animationDelay: "240ms" }}>
            <div>
              <p className="font-display text-xl font-bold text-brand-dark">₦4.2M+</p>
              <p className="mt-0.5 text-xs text-gray-500">Total Saved</p>
            </div>
            <div>
              <p className="font-display text-xl font-bold text-brand-dark">1,200+</p>
              <p className="mt-0.5 text-xs text-gray-500">Active Members</p>
            </div>
            <div>
              <p className="font-display text-xl font-bold text-brand-dark">340</p>
              <p className="mt-0.5 text-xs text-gray-500">Circles</p>
            </div>
          </div>

          <div className="animate-fade-up flex flex-col items-stretch gap-4 sm:flex-row sm:items-center" style={{ animationDelay: "320ms" }}>
            <Link
              href="/register"
            ...
            >
              See How It Works <ArrowUpRight className="h-5 w-5 text-gray-500" />
            </Link>
          </div>

          <div className="animate-fade-up mt-2 flex items-center gap-2 text-xs text-gray-500" style={{ animationDelay: "400ms" }}>
            <ShieldCheck className="h-4 w-4 text-brand-sage" />
            <span>Escrow-protected funds · KYC &amp; BVN verified · SSL encrypted</span>
          </div>
        </div>
        ...
        <div className="relative mt-8 lg:col-span-5 lg:mt-0">
          ...
          <div className="animate-img-in absolute -right-4 top-8 w-2/5 overflow-hidden rounded-2xl border-4 border-white bg-white shadow-xl md:w-1/2" style={{ animationDelay: "200ms" }}>
            <img
          ...
          <div className="animate-fade-up absolute -bottom-6 -left-4 hidden max-w-[200px] rounded-2xl border border-gray-100 bg-white p-4 text-left shadow-xl md:block" style={{ animationDelay: "500ms" }}>
            <div className="flex items-center gap-1.5">
              <div className="rounded bg-green-100 p-1 text-green-600">
                <ShieldCheck className="h-4 w-4" />
              </div>
              <span className="text-xs font-bold text-brand-dark">Trusted by communities</span>
            </div>
