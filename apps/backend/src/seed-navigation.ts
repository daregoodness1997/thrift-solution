...
const MEMBER_NAV: NavDef[] = [
  ...
  { label: "My Activity", href: "/activity", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z", section: "Member Portal" },
...
const STAFF_NAV: NavDef[] = [
  ...
  { label: "Payout Accounts", href: "/admin/payout-accounts", icon: "M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z", section: "Administration" },
  { label: "Payout Requests", href: "/admin/payout-requests", icon: "M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2z", section: "Administration" },
